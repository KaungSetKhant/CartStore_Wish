...
const Category = (props) => {
  ...
  return (
    <div data-aos="flip-right" className="flex flex-col flex-wrap ">
      <h2 className="text-gray-400 mb-3 mt-3">
        Category Result -{" "}
        <span className="bg-violet-500 text-white p-1 rounded-xl">
          {category}
        </span>
      </h2>
      <div className=" w-72 bg-white p-3 rounded area">
        <img
          src={image}
